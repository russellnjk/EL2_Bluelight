...
0.4469/0.2418;];    %degRFP 1/hr YbaQ

ub=[1.2;2; 0.001;5;0.8;0.3;3.5;2;2;];
lb=[1;0.0001;0.000001;0.0001;0.1;0.1;1;1;];
apply=[1;1;1;1;0;1;1;1;1;];

Init1  = [0          0         0;  %EL2a
         1.0*10^-6  1.0*10^-6  0.75*10^-6;  %RFP
         0          0          0;];  %mRFP

Init2  = [0          0           0;  %EL2a
         0.25*10^-6  0.25*10^-6  0.1*10^-6;  %RFP
         0           0           0;];  %mRFP
...
i=[default(1:6) default(1:6) default(1:6) default(1:6);default(7) default(8) default(9);];
initial=get_sse2(i);
disp(initial);
...
if make_plot==1
    ...
    legend('Cm','Dm','Ym','Ce','De','Ye','Location','Northwest');
    end
    figure;
